        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(nullable: false, defaultValueSql: "NEWID()"),
                    Name = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    UniversityId = table.Column<Guid>(nullable: false, defaultValueSql: "NEWID()"),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DeletedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(nullable: false, defaultValueSql: "NEWID()"),
                    Name = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    FacultyId = table.Column<Guid>(nullable: false, defaultValueSql: "NEWID()"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MethodType = table.Column<int>(type: "int", maxLength: 50, nullable: false),
                    MethodDetails = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(nullable: false, defaultValueSql: "NEWID()"),
                    SessionId = table.Column<Guid>(nullable: false, defaultValueSql: "NEWID()"),
                    SubjectId = table.Column<Guid>(nullable: false, defaultValueSql: "NEWID()"),
                    TutorId = table.Column<Guid>(nullable: false, defaultValueSql: "NEWID()"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RecurringStartOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                    RecurringFinishOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                    RecurringType = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SessionId = table.Column<Guid>(nullable: false, defaultValueSql: "NEWID()"),
                    StudentId = table.Column<Guid>(nullable: false, defaultValueSql: "NEWID()"),
                    TutorId = table.Column<Guid>(nullable: false, defaultValueSql: "NEWID()"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Complaints_Users_TutorId",
                        column: x => x.TutorId,
                        principalTable: "Users",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_PaymentTransactions_Users_TutorId",
                        column: x => x.TutorId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentSessions", x => new { x.SessionId, x.StudentId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PaymentTransactions_TutorId",
                table: "PaymentTransactions",
                column: "TutorId");
